...
class BlogPost
{
    ...
    {
        $query = "SELECT blog_posts.id, blog_posts.title, blog_posts.post, accounts.firstname, accounts.lastname, blog_posts.date_posted
FROM blog_posts
INNER JOIN accounts ON blog_posts.author_id = accounts.id";
